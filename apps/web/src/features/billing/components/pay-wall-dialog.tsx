          ...
          <div className="grid min-h-0 grid-cols-1 md:grid-cols-2">
            <div className="flex flex-col p-6">
              ...
              <div className="space-y-4 pt-4">
                {selectedPlan === "pro" && (
                  <div className="b flex items-start justify-between gap-4 rounded-lg border border-muted-border border-dashed bg-muted/50 p-4">
                    <div className="mt-1">
                      <BadgeDollarSignIcon className="size-5 text-green-600" />
                    </div>
            ...
            <div className="hidden overflow-y-auto bg-muted px-6 py-6 md:block">
