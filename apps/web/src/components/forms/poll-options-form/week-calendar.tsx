          ...
          eventWrapper: function EventWraper(props) {
            ...
            return (
              ...
              <div
                ...
                className="group absolute ml-1 flex max-h-full flex-col justify-between overflow-hidden rounded-lg border border-border bg-card p-1 text-foreground text-xs shadow-xs backdrop-blur-sm hover:cursor-pointer"
                style={{
